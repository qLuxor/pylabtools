...
print("\nResultTekk = ", resultTekk, file = outputFile)
print("\nResquadTekk = ", resquadTekk, file = outputFile)
print("\nPurity = ", purityTekk, file = outputFile)
print("\nCorrection = ", resultCorrection, file = outputFile)